...
def test_compare_documents():
    ref_path = Path("E:\\Tanmoy Saha\\Upskill\\Tech Stack\\Projects\\Document Portal\\data\\document_compare\\sample 1.pdf")
    act_path = Path("E:\Tanmoy Saha\\Upskill\\Tech Stack\\Projects\\Document Portal\\data\\document_compare\\sample 2.pdf")
